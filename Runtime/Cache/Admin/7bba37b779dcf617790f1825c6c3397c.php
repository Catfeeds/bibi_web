...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('HeroMessage/add');?>">新 增</a>
    ...
    <tbody>
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["hero_name"]); ?></td>
			<td><?php echo ($vo["skill_info"]); ?></td>
			<td><?php echo ($vo["equip_recommend"]); ?></td>
			<td><?php echo ($vo["background_story"]); ?></td>
			<td><?php echo ($vo["update_time"]); ?></td>
			<td><a href="<?php echo U('HeroMessage/edit?id='.$vo['id']);?>">编辑</a>
